<?php
// W nowej strukturze nie trzeba dołączać plików - init.php już je załadował
// Dostęp do obiektów przez funkcje globalne: getConf(), getMessages(), getSmarty()

require_once getConf()->root_path.'/app/controllers/CalcForm.class.php';
require_once getConf()->root_path.'/app/controllers/CalcResult.class.php';
