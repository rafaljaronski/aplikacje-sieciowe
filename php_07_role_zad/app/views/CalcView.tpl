...
{block name=footer}
	<p style="margin-top: 20px; opacity: 0.8;">
		<i class="fas fa-code"></i> Zadanie 6a - Automatyzacja z funkcją control() i rolami
	</p>
{/block}
...
<div style="text-align: right; margin-bottom: 20px;">
	<a href="{$conf->action_url}logout" style="color: #999; text-decoration: none;">
		Wyloguj
	</a>
</div>
...
<div class="calc-form">
	...
	<form action="{$conf->app_url}/ctrl.php" method="post">
